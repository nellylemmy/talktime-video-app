...
class JWTAuth {
    ...
    handlePostLoginRedirect() {
        ...
        if (redirectUrl) {
            ...
            // Ensure we're not redirecting back to login page
        ...
        if (user) {
            // Use absolute paths to prevent base URL issues
            ...
            switch (user.role) {
                case 'admin':
                    ...
                    break;
                case 'student':
                    window.location.href = `${baseUrl}/student/dashboard.html`;
                    break;
                case 'volunteer':
                default:
                    window.location.href = `${baseUrl}/volunteer/dashboard.html`;
                    break;
            }
        }
    }
